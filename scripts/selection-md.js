javascript: (() => {
    ...
    // TEMPLATE: Replace YOUR_SPIRTZ_URL with your actual Spirtz Voice instance URL (e.g. http://localhost:5173 or https://spirtz.app)
    const baseUrl = "YOUR_SPIRTZ_URL";

    // Check if baseUrl is set
    if (baseUrl === "YOUR_SPIRTZ_URL") {
        alert("Please configure the Spirtz Voice URL in the bookmarklet code.");
        return;
    }
